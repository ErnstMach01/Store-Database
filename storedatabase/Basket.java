...
interface Basket {                  //Interface for shopping list
    void addItem(Good item);        //Method to add a good to the shopping list
    void removeItem(Good item);     //Method to remove a good from the shopping list
    ArrayList<Good> getItems();     //Method to get all the goods currently in the shopping list
}